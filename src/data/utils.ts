...
function getAPIPath() {
    return "https://api-collections.vercel.app/api/smmpanels.net/"
    return "http://localhost:4322/api/smmpanels.net/"
}

function getImageBasePath() {
    return "https://secureurl.github.io/cloud/smmpanels.net%20images/";
}
